...
urlpatterns = [
    ...
    path('get_favourite/<str:username>', views.update_get_favourite, name="get_favourite"),
    path('get_bookmark/<str:username>', views.update_get_bookmark, name="get_bookmark")
]